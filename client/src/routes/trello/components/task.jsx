...
function Task({ id, text, isCompleted, completeTask, deleteTask, columnIndex, changeColumnTaskToleft, changeColumnTaskToRight, columnsLength }) {
  ...
  return (
    <div className="tasks-container">
      {columnIndex !== 1 ?
        <div className="row" onClick={() => changeColumnTaskToleft(id)}>
          <AiOutlineArrowLeft />
        </div>
        : null}
      ...
      {columnIndex !== columnsLength ?
        <div className="row" onClick={() => changeColumnTaskToRight(id)}>
          <AiOutlineArrowRight />
        </div>
        : null}
    </div>
